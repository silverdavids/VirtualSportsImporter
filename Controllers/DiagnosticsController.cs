...
public sealed class DiagnosticsController : ControllerBase
{
        ...
        VirtualSportsOptions virtualSports)
    {
        return new Dictionary<string, bool>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["ReportTimeZone"] = IsConfigured(virtualSports.ReportTimeZone),
            ["TodayToMode"] = IsConfigured(virtualSports.TodayToMode),
            ...
            ["ReportSelectors.AgentInput"] = IsConfigured(virtualSports.Selectors.AgentInput),
            ["ReportSelectors.AgentOption"] = IsConfigured(virtualSports.Selectors.AgentOption),
            ...
            ["ReportSelectors.TimeframeSelect"] = IsConfigured(virtualSports.Selectors.TimeframeSelect),
            ["ReportSelectors.TimeframeTodayText"] = IsConfigured(virtualSports.Selectors.TimeframeTodayText),
            ["ReportSelectors.TimeframeYesterdayText"] = IsConfigured(virtualSports.Selectors.TimeframeYesterdayText),
            ["ReportSelectors.TimeframeCustomText"] = IsConfigured(virtualSports.Selectors.TimeframeCustomText),
            ...
            ["ReportSelectors.ReportErrorMessage"] = IsConfigured(virtualSports.Selectors.ReportErrorMessage),
